...
/** The five-stop falloff that makes a stroke read as a gas tube. */
...
const STRIKE = { opacity: [0, 1, 0.15, 1, 0.5, 1], filter: ["brightness(0.4)", "brightness(1.5)", "brightness(0.5)", "brightness(1.2)", "brightness(0.8)", "brightness(1)"] };
          ...
          <span className="flex items-baseline gap-2.5">
            <Icon
              style={{
                ...
                filter: `drop-shadow(0 0 3px #fff) drop-shadow(0 0 9px ${c}) drop-shadow(0 0 22px ${c})`,
                alignSelf: "center",
              }}
            />
            <span
              style={{
                ...
                color: "#fffdf6", textShadow: glow(c, fontSize / 24),
                whiteSpace: "nowrap",
              }}
            >
              {e.label}
    ...
    <div ref={containerRef} className="fixed inset-0 z-[60] pointer-events-none">
      <motion.div
        ...
        style={{
          ...
          background:
            `radial-gradient(120% 55% at 50% 34%, rgba(255,190,120,0.11), transparent 62%),` +
            `radial-gradient(90% 40% at 50% 104%, rgba(150,140,255,0.10), transparent 70%),` +
          ...
          >
            ...
            <motion.div
              ...
              style={{
                ...
                boxShadow:
                  `0 0 4px #fff6e0, 0 0 14px rgba(255,212,137,0.8), 0 0 40px rgba(255,212,137,0.4),` +
            ...
            >
              <div
                ...
                style={{
                  ...
                  textShadow: "0 0 3px #fff, 0 0 10px #ffd489, 0 0 26px #ffd489",
                }}
              >
