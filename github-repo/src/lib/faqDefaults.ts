...
const GENERAL: DefaultEntry[] = [
  ...
  { title: "How are the tiers structured?", sections: [
    ...
    S("Tier 2", "Adds SPC Outlook, Warnings & Reports, Severe Weather History, SSWXCon, Forecast Game, Loyalty, Lightning Density and Aurora — and unlocks Warning / Watch / Outlook-escalation alerts."),
...
const MODULES: DefaultEntry[] = [
  ...
  m("Warnings & Reports", "/warnings", 2, "Live NWS watches, warnings and ground truth.", "Two subtabs: every active NWS alert nationwide, and the Local Storm Reports people on the ground have actually filed — hail sizes, wind speeds, tornado sightings, with times and places.", "Flip to Storm Reports during an event to see what has verified.", "Enable push from My Profile to get warnings the moment they're issued."),
