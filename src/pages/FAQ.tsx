...
const MODULES: ModuleDoc[] = [
  ...
  { id: "/rotation", label: "Radar & MRMS", tier: 3, desc: "Live NEXRAD radar, national MRMS mosaics, and GOES satellite overlays.", what: "Single-site reflectivity & velocity (rotation couplets), national MRMS reflectivity & ProbSevere, plus True Color / IR / Air Mass satellite.", how: "Pick a group tab, choose a product, and a station for live radar. Use velocity + ProbSevere to spot rotation." },
